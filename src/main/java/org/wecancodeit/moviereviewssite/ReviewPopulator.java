...
public class ReviewPopulator implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		Tag inColor = tagRepo.save(new Tag("in color"));
		Tag inBlackAndWhite = tagRepo.save(new Tag("in black and white"));
		Tag fantasy = tagRepo.save(new Tag("fantasy"));
		Tag ratedPg13 = tagRepo.save(new Tag("rated PG-13"));
		Tag ratedPg = tagRepo.save(new Tag("rated PG"));
		Tag ratedR = tagRepo.save(new Tag("rated R"));
		...
		reviewRepo.save(new Review("Groundhog Day", "images/groundhog.jpg",
				...
				"1993", "renaldo and clara", comedy, inColor, fantasy, ratedPg13));

		reviewRepo.save(new Review("The Good, the Bad and the Ugly", "images/cowboy.jpg",
				...
				"1966", "MadReviewer", action, inColor, ratedR));

		reviewRepo.save(new Review("The Silence of the Lambs", "images/knife.jpg",
				...
				"1991", "pooch-8", drama, inColor, ratedR));

		reviewRepo.save(new Review("Inception", "images/top.jpg",
				...
				"2010", "marcusdean118", action, inColor, fantasy, ratedPg13));

		reviewRepo.save(new Review("Seven Samurai", "images/castle.jpg",
				...
				"1954", "yippeiokiyay", drama, inBlackAndWhite, ratedPg));

		reviewRepo.save(new Review("Saving Private Ryan", "images/tank.jpg",
				...
				"1998", "morales123", drama, inColor, ratedR));

		reviewRepo.save(new Review("Casablanca", "images/plane.jpg",
				...
				"1942", "RWiggum", drama, inBlackAndWhite, ratedPg));
	}
